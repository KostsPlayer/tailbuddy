...
function PhotographyServicesManModal({
  type = "create",
  isOpen,
  setIsOpen,
  refreshData,
  ...
  const photographyModal = useRef(null);
  ...
  useEffect(() => {
    if (type === "create") {
      ...
      if (dataId) {
        apiConfig
          .get(`${endpointsServer.photographyServices}/${dataId}`, {
            headers: {
      ...
      if (type === "create") {
        try {
          ...
          const promise = apiConfig.post(
            `${endpointsServer.photographyServices}/create`,
            { name: values.name, price: values.price },
            {
              headers: {
                Authorization: `Bearer ${token}`,
          ...
          toastPromise(
            ...
            {
              pending:
                "Creating photography services data on progress, please wait..!",
        ...
        try {
          ...
          const promise = apiConfig.put(
            `${endpointsServer.photographyServices}/update/${dataId}`,
            { name: values.name, price: values.price },
            {
              headers: {
                Authorization: `Bearer ${token}`,
          ...
          toastPromise(
            ...
            {
              pending:
                "Updating photography services data on progress, please wait..!",
  ...
  const handleDelete = useCallback(
    (e) => {
      ...
      const promise = apiConfig.delete(
        `${endpointsServer.photographyServices}/delete/${dataId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      toastPromise(
        ...
        {
          pending:
            "deleting photography services data on progress, please wait..!",
    ...
    <>
      {type === "delete" ? (
        ...
        <Modal
          ...
          otherTitleModal={"Photography Services"}
          isOpen={isOpen}
          setIsOpen={setIsOpen}
          modalRef={photographyModal}
        >
...
PhotographyServicesManModal.propTypes = {
...
export default PhotographyServicesManModal;
